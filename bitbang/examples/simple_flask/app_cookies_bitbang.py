"""Cookie/session test using BitBang Python adapter directly.
Tests that cookies flow through the SW cookie jar and SWSP header forwarding."""
...
<h1>Cookie Test (BitBang Python)</h1>
<p>{status}</p>
{action}
{admin}
<hr>
...
if __name__ == '__main__':
    adapter = BitBangWSGI(app, program_name='cookie_test')
    adapter.run()
